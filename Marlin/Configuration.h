...
#define STRING_CONFIG_H_AUTHOR "(Wooden Nautilus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Wooden Nautilus"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 411.94 }
